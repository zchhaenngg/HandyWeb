...
/************在toolbar上将每个button生成的jquery对象保存*****************************/
btn.$linkbutton = _61;
/**********************************************************************************/
}
}
...
/***********support toolbar onLoadSuccess*****************************/
for (var i = 0; opts.toolbar != null && i < opts.toolbar.length; i++) {
    var btn = opts.toolbar[i];
    if(typeof btn == "object" && typeof btn.onLoadSuccess == 'function') {
        btn.onLoadSuccess.call(btn.$linkbutton, data);
    }
}
/********************************************************************/
...
/********support toolbar rowOnSelect*****************************/
for (var i = 0; opts.toolbar != null && i < opts.toolbar.length; i++) {
    var btn = opts.toolbar[i];
    if (typeof btn == "object" && typeof btn.rowOnSelect == 'function') {
        
        btn.rowOnSelect.apply(btn.$linkbutton, [_123, row]);
    }
}
/***************************************************************/
_118(_122,_123);
